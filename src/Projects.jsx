...
const projects = [
  {
    ...
    project_link: "https://meghanacosmos.github.io/",
    ...
    description: (
      <div>
        ...
        . I took most of the design inspiration from the figma designs provided
        by them.
      </div>
    ),
  },
  {
    ...
    code_link: "https://github.com/meghanacosmos/kozy-klassroom",
    description: (
      <div>
  ...
  },
  {
    ...
    code_link: "https://github.com/meghanacosmos/Chat-App",
    description:
      "This is a simple Chat application built using ReactJS and firebase. This helped my get hang of Firebase.",
  },
];
  ...
  return (
    <div className="flex flex-col justify-evenly gap-4 ">
        ...
        <div className="flex flex-row gap-2 flex-wrap m-2">
          <button
            className={`btn-outlined rounded-2xl border-2 ${
              active === "all" ? "dark:bg-sky-800 bg-sky-500 text-white" : ""
            }`}
            data-id="all"
          ...
          <button
            className={`btn-outlined rounded-2xl border-2 ${
              active === "reactjs" && "dark:bg-sky-800 bg-sky-500 text-white"
            }`}
            data-id="reactjs"
            onClick={e => handleClick(e)}
          >
          ...
          <button
            className={`btn-outlined rounded-2xl border-2 ${
              active === "firebase" && "dark:bg-sky-800 bg-sky-500 text-white"
            }`}
            data-id="firebase"
            onClick={e => handleClick(e)}
          >
          ...
          <button
            className={`btn-outlined rounded-2xl border-2 ${
              active === "tailwind" && "dark:bg-sky-800 bg-sky-500 text-white"
            }`}
            data-id="tailwind"
            onClick={e => handleClick(e)}
          >
      ...
      <div className="flex justify-center">
        {Array.apply(null, {
          length: projectsArray.length / 2 + (projectsArray.length % 2),
        }).map((item, i) => (
          <button
