...
import { DESCRIPTION, HEADER, RESUME, ROLE } from "../consts/profile";
...
function Profile() {
  return (
    <div className="card flex sm:flex-row flex-col justify-center sm:justify-start">
      <div className="rounded-md overflow-hidden sm:w-1/3 self-center">
        <img src={ProfileImage} alt="profile-img" />
      </div>
      <div className="flex flex-col p-4 sm:w-3/4 gap-y-2">
        ...
        <br />
        <div className="text-left text-zinc-400 text-sm">{DESCRIPTION}</div>
        <a
          className="btn self-center place-end"
          href={RESUME.HREF}
          download
          target="_blank"
          rel="noreferrer"
