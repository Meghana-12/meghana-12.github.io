...
function Achievements() {
  return (
    <div className="card flex flex-col gap-4 w-full">
      ...
      <Achievement img={MLH} role="MLH Prep Fellow '22" duration="Apr 2022" />
      <Achievement
        img={Microsoft}
        role="Mentee, Microsoft Engage 2021"
        duration="Nov 2021"
      />
      <Achievement
        img={Tie}
        role="Tie University Global Business Hackathon | Winning Team"
        duration="Mar 2021"
      />
      <Achievement
        img={Hacktoberfest}
        role="Hacktoberfest Challenge 2020"
        duration="Oct 2020"
      />
      <Achievement
        img={Technica}
        role="Technica Hackathon | Winning team "
        duration="Oct 2020"
      />
    </div>
  );
