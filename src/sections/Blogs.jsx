  ...
  return (
    <div className="card w-fill gap-4">
      ...
      <Blog
        title="First Blog"
        img={First}
        url="https://hashnode.com/@meghanacosmos"
      >
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veniam hic
        aperiam nulla consequatur ad voluptates veritatis minus? Praesentium,
        omnis tempora, minima eius, eos deserunt ab repellendus distinctio
