...
const HEADER = "Hi Amigos! I'm a Full Stack Deveplor based in India.";
const ROLE = "Full Stack Developer";

const DESCRIPTION = (
  <>
    {" "}
    I've got hands-on experience in full-stack development. On the front-end,
    I'm familiar with{" "}
    <i>
      <b>TypeScript</b>
    </i>{" "}
    and React Query, while on the back-end, I've worked extensively with Node.js
    and PostgreSQL.
    <br />
    <br />
    ...
    to participating actively in hackathons, mentoring, and contributing to
    open-source projects. And if you think development is the only thing I do,
    darling, you got me all wrong, I play guitar, make art and more importantly
    have fun :D
    <br />
    <br />
